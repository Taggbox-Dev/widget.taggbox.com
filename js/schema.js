...
document.querySelectorAll(".taggbox-schema-code").forEach(el =>
    TagboxSocialSchema.gSD(el.getAttribute("data-ref"), el.getAttribute("data-feed-ref"), el)
);