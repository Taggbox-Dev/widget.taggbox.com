var ApplicationEmbed = ApplicationEmbed || function (w, u) {
    ...
    return {
        init: function () {
            ...
            var container = socialwall && socialwall > 0 ? document.getElementsByClassName('taggbox-socialwall') : containerTaggbox ?  document.getElementsByClassName('taggbox') : document.getElementsByClassName('tagshop');
